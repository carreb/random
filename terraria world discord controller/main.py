...
async def wiki(ctx):
    ...
    await ctx.send('More functionality will be added to this command soon (search)')
...
async def annoy(ctx):
    await ctx.send('OK')
    user = client.get_user(186538091744460800)
    await user.send('Give Atlas the location of the stone chest and this will stop.')
    await user.send('Give Atlas the location of the stone chest and this will stop.')
    await user.send('Give Atlas the location of the stone chest and this will stop.')
    await user.send('Give Atlas the location of the stone chest and this will stop.')
    await user.send('Give Atlas the location of the stone chest and this will stop.')
    ...
    await user.send('Give Atlas the location of the stone chest and this will stop.')
    await user.send('Give Atlas the location of the stone chest and this will stop.')
    await ctx.send('Annoying complete.')

@client.command()
async def heresmybrotherluiginowtotellyouawholeheapinspaghettipileofinformatione(ctx):
    await ctx.send ('Hello Mario.')
...
client.run('Nzc5MDI1NTAzMDA4NzE4ODU4.X7aiCQ.FrhOnYSLuUFtWbpw2XzkcZalOYU')